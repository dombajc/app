...
class Itempbbkb extends CI_Controller {
	...
	{
		$data['title'] = 'JENIS PAJAK BAHAN BAKAR KENDARAAN BERMOTOR (PBBKB)';
		$data['subtitle'] = '';
	...
	{
		$cond = '1=1';
		$sort = empty($_POST['sortdatafield']) || $_POST['sortdatafield'] == '' ? 'id_item_pbbkb asc' : $_POST['sortdatafield']." ". $_POST['sortorder'];
		$cond .= empty($_POST['cariNama']) || $_POST['cariNama'] == '' ? '' : " and item_pbbkb like '%". $_POST['cariNama'] ."%'";

		$items = $this->Pbbkb->getDataByCond($cond, $sort);
