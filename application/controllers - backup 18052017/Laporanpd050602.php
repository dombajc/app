...
class Laporanpd050602 extends CI_Controller {
	...
	{
		$data['title'] = 'LAPORAN PD 02 / PD 03 / PD 05 / PD 06';
		$data['subtitle'] = '';
		$data['dinamisContent'] = $this->folder.'form laporan pd 05 06 02';
	...
	public function act_report()
	{
		...
		if ( $postbentuk == '02' ) {
			...
			$data['header_lokasi'] = $postinduk == $postlokasi ? 'UP3AD : '. str_replace('UP3AD ', '', $this->Lokasi->getDataByIdLokasi($postlokasi)->row()->lokasi) : 'UP3AD : '. str_replace('UP3AD ', '', $this->Lokasi->getDataByIdLokasi($postinduk)->row()->lokasi) .'('. $this->Lokasi->getDataById($postlokasi)->row()->lokasi .')';
			...
			$data['dinamisContent'] = $this->folder.'pd 05 pd 06 pd 02/cetak pd 02';
			$data['namafile'] = 'pd 02';
			...
			$data['dinamisContent'] = $this->folder.'pd 05 pd 06 pd 02/cetak pd 03';
			$data['namafile'] = 'pd 03';
		} elseif ( $postbentuk == '05') {
			...
			$data['dinamisContent'] = $this->folder.'pd 05 pd 06 pd 02/cetak pd 05';
			$data['namafile'] = 'pd 05';
			...
			$data['dinamisContent'] = $this->folder.'pd 05 pd 06 pd 02/cetak pd 06';
			$data['namafile'] = 'pd 06';
		}
	...
	public function get_pdf()
	{
		...
		if ( $postbentuk == '02' ) {
			...
			$header_lokasi = $postinduk == $postlokasi ? 'UP3AD : '. str_replace('UP3AD ', '', $this->Lokasi->getDataByIdLokasi($postlokasi)->row()->lokasi) : 'UP3AD : '. str_replace('UP3AD ', '', $this->Lokasi->getDataByIdLokasi($postinduk)->row()->lokasi) .'('. $this->Lokasi->getDataById($postlokasi)->row()->lokasi .')';
...
<td align="center" colspan="6">'. $this->Paraf->getParafLaporan2('rd2d', $postinduk, 1 ) .'</td>
			...
			$dinamisContent = $this->folder.'pd 05 pd 06 pd 02/cetak pd 06';
			$namafile = 'pd 06';
