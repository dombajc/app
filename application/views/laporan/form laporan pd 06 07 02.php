...
<script>
	$(function(){
        ...
        $('#btn-pdf').click(function(){
    		...
    		var ifr=$('<iframe/>', {
                id:'MainPopupIframe',
                frameborder:0,
                src:"<?= base_url('pdflaporanpd060702') ?>" + "/type/excel/"+ param,
        ...
        $('#btn-excel').click(function() {
			...
			var getlokasi = $('#slctlokasi').val();
			var param = 'getbentuk/'+ getbentuk +'/getbulan/'+ getbulan +'/gettahun/'+ gettahun +'/getinduk/'+ getinduk +'/getlokasi/'+ getlokasi;
        	location.href = "<?= base_url('viewlaporanpd060702') ?>" + "/type/excel/"+ param;
        });
	});
	...
	function load_display_laporan()
	{
		...
		var ifr=$('<iframe/>', {
            id:'MainPopupIframe',
            frameborder:0,
            src:"<?= base_url('viewlaporanpd060702') ?>" + "/type/frame/"+ param,
