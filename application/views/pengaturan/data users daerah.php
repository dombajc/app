    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="forms form-horizontal">
			...
			<input type="hidden" name="slctakses" value="0">
			<input type="hidden" name="slctstatus" value="0">
            <div class="box-body">
				<div class="row">
					<div class="col-md-7">
						<!-- Default box -->
								...
								<div class="form-group">
								  ...
								  <div class="col-sm-8">
									<select name="slctlokasi" id="slctlokasi" class="form-control">
										<?= $this->Lokasi->optionSelectLokasiByUserLogin() ?>
									</select>
								  </div>
								</div>
								<div class="form-group">
						...
						<div class="box-body">
							<div class="form-group">
							  <div class="col-sm-12">
								...
								<div id="pilihanmenu">
									<?= $this->Menu->ShowPilihanMenuDaerah() ?>
								</div>
							  </div>
							</div>
						</div><!-- /.box-body -->
