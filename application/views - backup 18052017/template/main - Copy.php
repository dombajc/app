...
<html>
    ...
    <body class="skin-black">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?= base_url() ?>/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
		...
		<!-- Notification Fx -->
		<script src="<?= base_url('plugins/NotificationStyles-master/js/classie.js') ?>"></script>
		<script src="<?= base_url('plugins/NotificationStyles-master/js/modernizr.custom.js') ?>"></script>
		<script src="<?= base_url('plugins/NotificationStyles-master/js/notificationFx.js') ?>"></script>
