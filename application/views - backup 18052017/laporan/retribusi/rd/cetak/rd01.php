<table style="font-size:8pt;border-collapse:collapse; width:100%; font-weight:bold;" cellpadding="3">
...
<br>
<table style="font-size:7pt;border-collapse:collapse;" cellpadding="5" border="1">
	<thead>
		<tr>
			<th>No. REKENING</th>
			<th width="20%">NAMA REKENING</th>
			<th width="8%">TARGET</th>
			<th width="5%">TUNGGAKAN S/D BLN LALU</th>
			<th width="8%">PENETAPAN BULAN INI</th>
			<th width="8%">S/D BLN LALU</th>
			<th width="8%">BULAN INI</th>
			<th width="5%">DENDA BLN INI</th>
			<th width="8%">S/D BULAN INI</th>
			<th width="5%">%</th>
		</tr>
	</thead>
	<tbody>
		<?= $this->Rekeningpad->laporan_rd01($tahun, $bulan, $lokasi, $target) ?>
	</tbody>
</table>
