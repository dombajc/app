	...
	<div class="col-md-12">
		...
		<div class="box box-warning">
			<div class="box-header with-border">
				<h3 class="box-title">Laporan Pengiriman Dokumen D2D</h3>
			</div>
		<div class="box-body">
			<div class="form form-horizontal">
				<div class="form-group">
				  ...
				  <div class="col-sm-3">
					<select id="slct_lokasi" class="form-control">
...
<script>
	$(function(){
        ...
        $('#btn-pdf').click(function(){
			var ifr=$('<iframe/>', {
                id:'MainPopupIframe',
                frameborder:0,
                src:"<?= base_url('viewpdfrekapd2d') ?>" + "/type/frame/ta/" + $('#slct_th').val() + "/tw/" + $('#slct_triwulan').val() + "/lok/" + $('#slct_lokasi').val(),
        ...
        $('#btn-excel').click(function() {
            location.href = "<?= base_url('viewlaprekapperupad') ?>" + "/type/excel/ta/" + $('#slct_th').val() + "/tw/" + $('#slct_triwulan').val() + "/lok/" + $('#slct_lokasi').val();
        });
	});
	...
	function load_display_laporan()
	{
		var ifr=$('<iframe/>', {
            id:'MainPopupIframe',
            frameborder:0,
            src:"<?= base_url('viewlaprekapperupad') ?>" + "/type/frame/ta/" + $('#slct_th').val() + "/tw/" + $('#slct_triwulan').val() + "/lok/" + $('#slct_lokasi').val(),
            style:'display:none;width:100%;height:600px;overflow:scroll',
            load:function(){
                $(this).show();
            }
