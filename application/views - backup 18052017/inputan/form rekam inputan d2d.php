	...
	<div class="col-lg-12">
		<section class="panel">
			<header class="panel-heading">
				Rekam Data Kegiatan Pengiriman Dok. D2D (SKPDPJ, SP1, SP2, SP3) :
			</header>
			<div class="panel-body form-horizontal">
				...
				<div class="form-group">
				  	<label class="col-sm-2 control-label">Cari Pegawai</label>
				  	<div class="col-sm-10">
...
<div class="row">
	<div class="col-lg-12" id="div-form-inputan" style="display:none;">
		<section class="panel">
			<header class="panel-heading">
				Entry Laporan jumlah pengiriman dokumen/obyek D2D :
			</header>
	                            ...
	                            if (html.error == '')
	                            {
									...
									$.each(html.arrBulan, function(key, value) {
										var getHtml = '<div class="form-group">'+
										  	'<label class="col-sm-3 control-label">'+ value.bulan +'</label>'+
										  	'<div class="col-sm-2">'+
										...
										if ( $('#id_sts_pegawai').val() == '33' ) {
											getHtml += '<div class="col-sm-2">'+
										...
										if ( value.id_lokasi == '' ) {
											$("#postLokasi_"+ value.id_bulan).val($('#slctlokasi').val());
										} else {
											$("#postLokasi_"+ value.id_bulan).val(value.id_lokasi);
										}

										if ( value.id_jabatan == '' ) {
											$("#postJabatan_"+ value.id_bulan).val($('#id_jabatan').val());
										} else {
